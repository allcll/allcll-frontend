...
const markdownComponents = {
  ...
  h3: (props: JSX.IntrinsicElements['h3']) => (
    <h3 {...props} className="text-base font-bold mt-6 mb-4 tracking-wide" />
  ),
  a: (props: JSX.IntrinsicElements['a']) => <a {...props} className="text-blue-500 underline" />,
  p: (props: JSX.IntrinsicElements['p']) => (
    <p {...props} className="mb-5 text-md text-gray-700 leading-loose tracking-normal" />
  ),
  ul: (props: JSX.IntrinsicElements['ul']) => (
    <ul {...props} className="list-disc list-inside space-y-3 mb-6 ml-2 text-md text-gray-700 tracking-normal" />
  ),
  ol: (props: JSX.IntrinsicElements['ol']) => (
    <ol {...props} className="list-decimal list-inside space-y-3 mb-6 ml-2 text-md text-gray-700 tracking-normal" />
  ),
  li: (props: JSX.IntrinsicElements['li']) => <li {...props} className="leading-loose tracking-normal" />,
  blockquote: (props: JSX.IntrinsicElements['blockquote']) => (
    <blockquote
      {...props}
      className="bg-gray-50 border-l-4 border-gray-300 rounded p-4 my-6 text-md text-gray-600 tracking-normal"
    />
  ),
  ...
  table: (props: JSX.IntrinsicElements['table']) => (
    <div className="overflow-x-auto mb-6">
      <table {...props} className="w-full border-collapse text-md" />
    </div>
  ),

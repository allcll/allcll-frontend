...
function PinCards({ subjects, isPending = false, className = '', isLive = false }: Readonly<IPinCards>) {
  return (
...
function Cards({ subjects, isPending = false, isLive = false }: Readonly<IPinCards>) {

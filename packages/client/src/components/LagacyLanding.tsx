      ...
      <section className="bg-gray-50 sm:px-4 py-20 px-20">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <Link to="/live" className="bg-blue-500 text-white px-6 py-3 rounded-lg shadow-md hover:bg-blue-600">
              무료로 시작하기
            </Link>
          </div>
            ...
            <ul>
              {StartPassages.map(({ title, content }, index) => (
                <li key={index} className="flex items-center gap-4 p-6 text-left">
                  <div className="bg-blue-500 text-white rounded-full size-12 flex justify-center items-center">
                    {index + 1}
                  </div>
                  <div>

        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm overflow-x-auto">
            ...
            <table className="min-w-full text-sm text-center">
              ...
              {[
                { id: "004310-004", name: "운영체제", prof: "이수형", rank: "1/2순위", time: "11/20초", interest: "상", result: "성공" },
                { id: "002381-001", name: "컴퓨터그래픽스", prof: "하이", rank: "1/2순위", time: "11/20초", interest: "상", result: "성공" },
                { id: "004110-007", name: "디지털시스템", prof: "Rajendra Chikal", rank: "1/2순위", time: "11/20초", interest: "상", result: "성공" },
                { id: "004310-004", name: "운영체제", prof: "이수형", rank: "1/2순위", time: "11/20초", interest: "중", result: "실패" },
                { id: "004310-004", name: "운영체제", prof: "이수형", rank: "1/2순위", time: "11/20초", interest: "하", result: "실패" },
              ].map((row, i) => (
            ...
            <div className="relative w-[900px] h-64 border-t border-l border-gray-200">
              ...
              {[
                ...
                <div key={i} className="flex items-center space-x-2 mt-4">
                  <div className={`text-sm ${item.success ? "text-black" : "text-red-500"}`}>
                    {item.label}
                  </div>
